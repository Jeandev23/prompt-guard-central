    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="border-b px-6 py-4">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold">Prompt Guard Central</span>
          </div>
          <div>
      ...
      <div className="flex-1 flex flex-col">
        <div className="container mx-auto py-16 flex flex-col items-center text-center max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900 mb-6">
            Secure AI Conversation Platform
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-xl">
            Experience our AI assistant with enhanced security measures that protect your sensitive information.
          </p>
      ...
      <footer className="bg-gray-800 text-white py-6">
        <div className="container mx-auto text-center">
          <p>© 2025 Prompt Guard Central. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
